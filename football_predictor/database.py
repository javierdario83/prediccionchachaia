...
PREDICTION_OPTIONAL_COLUMNS: dict[str, str] = {
    ...
    "home_team_seen": "INTEGER",
    "away_team_seen": "INTEGER",
    "team_coverage_note": "TEXT",
    "one_x_two_margin": "REAL",
    "match_balance_note": "TEXT",
    ...
    "value_gap": "REAL",
    "calibrated_pick_probability": "REAL",
    "calibration_bucket": "TEXT",
    "calibration_samples": "INTEGER",
    "calibration_hit_rate": "REAL",
    "weather_city": "TEXT",
